...
async def botattt(c, msg):
    await msg.edit(
        "[ΒỖŤ ŻĤŘƑÃ VENOM](http://t.me/z_h_r_f_a_bot)")
...
async def crist(c, msg):
    await msg.edit(
        "[⩹━★⊷⌯𝐒𝐎𝐔𝐑𝐂𝐄 VENOM⌯⊶★━⩺](https://t.me/R_R_B0)\n• تفعيل ، تعطيل الترحيب \n• قبول ، رفض\n• كتم ، الغاء كتم\n• سبام + الكلمه + الرقم (سبام cr 22)\n• ايدي + ايدي بالرد\n[⩹━★⊷⌯𝐒𝐎𝐔𝐑𝐂𝐄 VENOM⌯⊶★━⩺](https://t.me/R_R_B0)") 
